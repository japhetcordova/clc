    ...
    return (
        <div className="p-6 space-y-8 max-w-7xl mx-auto min-h-screen bg-background text-foreground transition-colors duration-300">
            ...
            <Tabs defaultValue="attendance" className="space-y-8">
                <div className="bg-muted/30 p-1 rounded-2xl inline-flex ring-1 ring-border">
                    <TabsList className="bg-transparent gap-2 h-10">
                        <TabsTrigger
                            value="attendance"
                            className="rounded-xl font-bold uppercase text-[10px] tracking-widest gap-2 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-lg"
                        >
                        ...
                        <TabsTrigger
                            value="demographics"
                            className="rounded-xl font-bold uppercase text-[10px] tracking-widest gap-2 data-[state=active]:bg-accent data-[state=active]:text-accent-foreground data-[state=active]:shadow-lg"
                        >
                ...
                <TabsContent value="attendance" className="space-y-8 animate-in fade-in zoom-in-95 duration-500">
                ...
                <TabsContent value="demographics" className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        <div className="lg:col-span-2 p-6 bg-accent/5 rounded-[2rem] border border-accent/10 flex flex-col justify-center gap-3">
                            <div className="flex items-center gap-2">
                                <Award className="w-5 h-5 text-accent" />
                                <h4 className="text-sm font-black uppercase tracking-widest text-accent">Registration Insight</h4>
                            </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <Card className="bg-card shadow-2xl border-border overflow-hidden">
                            <CardHeader className="bg-muted/30 border-b border-border">
                                <div className="flex items-center justify-between">
                                    ...
                                    <span className="text-[10px] font-black uppercase tracking-widest text-muted-foreground">Total by Group</span>
                                </div>
                            </CardHeader>
                            <CardContent className="pt-6 space-y-5">
                                {totalMinistryStats.map((stat) => (
                                    <div key={stat.name} className="space-y-2">
                                        <div className="flex justify-between text-[11px] font-black uppercase tracking-tight text-foreground/80">
                                            <span>{stat.name}</span>
                        ...
                        <Card className="bg-card shadow-2xl border-border overflow-hidden">
                            <CardHeader className="bg-muted/30 border-b border-border">
                                <div className="flex items-center justify-between">
                                    ...
                                    <span className="text-[10px] font-black uppercase tracking-widest text-muted-foreground">Global Reach</span>
                                </div>
                            </CardHeader>
                            <CardContent className="pt-6 space-y-4 max-h-[600px] overflow-y-auto pr-2 custom-scrollbar">
                                {totalNetworkStats.map((stat) => (
                                    <div key={stat.name} className="flex items-center justify-between p-3 rounded-2xl bg-muted/20 border border-border/50 hover:bg-muted/40 transition-colors">
                                        ...
                                        <div className="text-right">
                                            <p className="text-lg font-black text-blue-600">{stat.count} People</p>
                                            <p className="text-[9px] font-bold text-muted-foreground uppercase">{((stat.count / totalUsers.value) * 100).toFixed(1)}%</p>
                                        </div>
                                    </div>
                                ))}
                            </CardContent>
