...
import { UserCheck, Users2, Users, TrendingUp, Sparkles, Megaphone, LayoutGrid, GraduationCap } from "lucide-react";
    ...
    return (
        <div className="bg-muted/30 p-1.5 rounded-2xl inline-flex ring-1 ring-border w-full sm:w-auto overflow-x-auto no-scrollbar">
            <TabsList className="bg-transparent gap-1.5 h-11 w-full sm:w-auto">
                ...
                <TabsTrigger
                    value="g12-journey"
                    onClick={() => updateTab("g12-journey")}
                    className="flex-1 sm:flex-none rounded-xl font-black uppercase text-[9px] sm:text-[10px] tracking-widest gap-2 data-[state=active]:bg-emerald-500 data-[state=active]:text-white data-[state=active]:shadow-lg h-8 px-4"
                >
                ...
                <TabsTrigger
                    value="cell-groups"
                    onClick={() => updateTab("cell-groups")}
                    className="flex-1 sm:flex-none rounded-xl font-black uppercase text-[9px] sm:text-[10px] tracking-widest gap-2 data-[state=active]:bg-violet-600 data-[state=active]:text-white data-[state=active]:shadow-lg h-8 px-4"
                >
